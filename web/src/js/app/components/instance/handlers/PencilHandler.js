...
export default class PencilHandler extends BaseHandler {
  path: Array<number>;
  ...
  handleMouseUp(x: number, y: number) {
    ...
    SocketActions.addPencilDrawing(this.sessionId, this.slideId, this.color, path);
  ...
  handleMouseClick(x: number, y: number) {
    console.debug('PencilHandler ~ MouseClickHandler: this will not be used');
  }
}
