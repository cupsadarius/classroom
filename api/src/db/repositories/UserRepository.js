...
var UserRepository = (function (_super) {
    ...
    function UserRepository() {
        ...
        _this.mapper = MapperFactory_1.default.getMapper('User');
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.map(function (userData) { return _this.mapper.hydrate(new User_1.default(), userData); })];
                    case 2:
                        e_1 = _a.sent();
                        return [2 /*return*/, e_1];
    ...
    UserRepository.prototype.getByEmail = function (email, stripSensitive) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.mapper.hydrate(new User_1.default(), data)];
                    case 2:
                        e_2 = _a.sent();
                        return [2 /*return*/, e_2];
                    case 3: return [2 /*return*/];
    ...
    UserRepository.prototype.getMapper = function () {
        return this.mapper;
    };
