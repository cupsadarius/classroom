...
db_1.db.setSchema(schema);
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                db_1.db.on('ready', resolve);
                db_1.db.on('error', reject);
                db_1.db.connect({
                    host: params_1.default.DB_HOST,
                    port: params_1.default.DB_PORT,
                    db: params_1.default.DB_NAME,
                });
            })];
    });
}); };
