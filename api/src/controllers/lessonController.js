...
var uploader_1 = require("../middlewares/uploader");
var lessonService_1 = require("../services/lessonService");
...
router.get('/', authenticated_1.authenticated, authorizedWithRole_1.authorizedWithRole('ROLE_TEACHER'), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, lessonService_1.lessonService.getAllLessons()];
            case 1:
                lessons = _a.sent();
                res.status(200);
                res.json(new SuccessResponse_1.default(lessons));
                return [3 /*break*/, 3];
            case 2:
                e_1 = _a.sent();
                res.status(400);
...
router.post('/', authenticated_1.authenticated, authorizedWithRole_1.authorizedWithRole('ROLE_TEACHER'), uploader_1.upload.any(), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var lessonId, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, lessonService_1.lessonService.saveLesson(req.body, req.files['slide'])];
            case 1:
                lessonId = _a.sent();
                res.status(201);
                res.json(new SuccessResponse_1.default(lessonId));
                return [3 /*break*/, 3];
            case 2:
                e_2 = _a.sent();
                res.status(400);
...
router.get('/:id', authenticated_1.authenticated, authorizedWithRole_1.authorizedWithRole('ROLE_TEACHER'), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, lessonService_1.lessonService.getById(req.params.id)];
            case 1:
                lesson = _a.sent();
                res.status(200);
                res.json(new SuccessResponse_1.default(lesson));
                return [3 /*break*/, 3];
            case 2:
                e_3 = _a.sent();
                res.status(400);
...
router.put('/:id', authenticated_1.authenticated, authorizedWithRole_1.authorizedWithRole('ROLE_TEACHER'), uploader_1.upload.any(), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        res.json('update');
        return [2 /*return*/];
    });
